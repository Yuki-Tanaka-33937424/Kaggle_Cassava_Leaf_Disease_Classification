...
clean_ids = np.load('/home/yuki/kaggle/input/cleanlab-data/clean_ids.npy', allow_pickle=True)
clean_labels = np.load('/home/yuki/kaggle/input/cleanlab-data/clean_labels.npy')
clean_guesses = np.load('/home/yuki/kaggle/input/cleanlab-data/clean_guesses.npy')
noisy_ids = np.load('/home/yuki/kaggle/input/cleanlab-data/noisy_ids.npy', allow_pickle=True)
noisy_labels = np.load('/home/yuki/kaggle/input/cleanlab-data/noisy_labels.npy')
noisy_guesses = np.load('/home/yuki/kaggle/input/cleanlab-data/noisy_guesses.npy')

train = train.sort_values(by='image_id', ascending=True)
train['filter'] = train['image_id'].apply(lambda x: True if x in clean_ids else False)
train = train[train['filter']]
train = train.drop('filter', axis=1).reset_index(drop=True)
